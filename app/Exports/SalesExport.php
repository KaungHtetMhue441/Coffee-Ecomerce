...
class SalesExport implements FromView, WithStyles, WithColumnWidths, WithEvents
{
    private $sales;
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            ...
            1 => [
                ...
                'alignment' => [
                    'horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER, // Center headers
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getRowDimension(1)->setRowHeight(35); // Set header height to 30

                // Set other rows height (rows 2 and beyond)
                for ($i = 2; $i <= $sheet->getHighestRow(); $i++) {
                    $sheet->getRowDimension($i)->setRowHeight(30); // Set other rows height to 20
                }
    ...
    {
        return view('admin.exports.sale', [
            'sales' => $this->sales
        ]);
    }
}
